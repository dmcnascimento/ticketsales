...
CREATE TABLE tb_session (id_session INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, dt_session TIMESTAMP NOT NULL,
...
CREATE TABLE tb_ticket (id_ticket INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	id_session INTEGER NOT NULL REFERENCES tb_session(id_session), id_chair INTEGER NOT NULL REFERENCES tb_chair(id_chair));
